...
{ 	
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	...
 	GPIO_SetBits(GPIOB,GPIO_Pin_9|GPIO_Pin_7|GPIO_Pin_8);	//|GPIO_Pin_7|GPIO_Pin_8
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	...
 	GPIO_SetBits(GPIOC,GPIO_Pin_13|GPIO_Pin_1|GPIO_Pin_0);	
	GPIO_ResetBits(GPIOC,GPIO_Pin_12);//低电平 
